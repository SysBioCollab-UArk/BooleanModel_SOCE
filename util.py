...
1: Ca_cyt_1* = (Ca_cyt_1 or (Ca_ext and Ca_channel) or Ca_ER) and not Ca_cyt_2 and not Ca_cyt_3 or (Ca_cyt_2 and not Ca_cyt_3 or Ca_cyt_3 and not Ca_cyt_2) and not Ca_pump_ER or (Ca_cyt_2 and Ca_cyt_3 and Ca_ext and Ca_channel and not Ca_ER)
1: Ca_cyt_2* = (Ca_cyt_2 or (Ca_ext and Ca_channel) or Ca_ER) and not Ca_cyt_1 and not Ca_cyt_3 or (Ca_cyt_1 and not Ca_cyt_3 or Ca_cyt_3 and not Ca_cyt_1) and not Ca_pump_ER or (Ca_cyt_1 and Ca_cyt_3 and Ca_ext and Ca_channel and not Ca_ER)
1: Ca_cyt_3* = (Ca_cyt_3 or (Ca_ext and Ca_channel) or Ca_ER) and not Ca_cyt_1 and not Ca_cyt_2 or (Ca_cyt_1 and not Ca_cyt_2 or Ca_cyt_2 and not Ca_cyt_1) and not Ca_pump_ER or (Ca_cyt_1 and Ca_cyt_2 and Ca_ext and Ca_channel and not Ca_ER)
'''
